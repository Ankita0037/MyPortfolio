  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.h1 className="text-3xl sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-amber-200 to-purple-300">
          Get in Touch
        </motion.h1>
      </motion.div>
      ...
      >
        <div className="flex flex-col sm:flex-row gap-8 items-center">
          ...
          >
            <motion.img
              src="/contact_Background-removebg-preview.png"
            ...
            <form ref={form} onSubmit={sendEmail} className="space-y-6 w-full">
              ...
              >
                ...
                <motion.span
                  ...
                  animate={
                    isSubmitted ? "submit" : isHovering ? "hover" : "initial"
                  }
                >
